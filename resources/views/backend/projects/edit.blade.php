<x-layouts.backend title="Edit Project">

    <div style="display:flex;align-items:center;gap:1rem;margin-bottom:2rem">
        <a href="{{ route('admin.projects.show', $project) }}" class="btn btn-secondary btn-sm" title="Back">
            <i class="ri-arrow-left-line"></i>
        </a>
        <div>
            <h1 class="page-title">Edit Project</h1>
            <p class="page-subtitle" style="font-family:'Syne',sans-serif;font-weight:700;color:#FF6400">{{ $project->project_code }}</p>
        </div>
    </div>
            ...
            <div class="form-grid-2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="client_name" name="client_name"
                        ...
                        value="{{ old('client_name', $project->client_name) }}" placeholder="e.g. Acme Corp">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title"
                        ...
                        value="{{ old('title', $project->title) }}" placeholder="e.g. E-Commerce Website">
                ...
                <div class="form-group" style="grid-column:span 2">
                    ...
                    <textarea id="description" name="description" rows="3"
                        ...
                        placeholder="Brief overview…">{{ old('description', $project->description) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="developer_name" name="developer_name"
                        ...
                        value="{{ old('developer_name', $project->developer_name) }}" placeholder="Team member or freelancer">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="cost" name="cost" step="0.01" min="0"
                        ...
                        value="{{ old('cost', $project->cost) }}" placeholder="0.00">
                ...
                <div class="form-group">
                    ...
                    <select id="currency" name="currency" class="form-control @error('currency') is-invalid @enderror">
                        @foreach($currencies as $cur)
                            <option value="{{ $cur }}" {{ old('currency', $project->currency) === $cur ? 'selected' : '' }}>{{ $cur }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="live_url" name="live_url"
                        ...
                        value="{{ old('live_url', $project->live_url) }}" placeholder="https://example.com">
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="testing_url" name="testing_url"
                        ...
                        value="{{ old('testing_url', $project->testing_url) }}" placeholder="https://staging.example.com">
                ...
                <div class="form-group" style="grid-column:span 2">
                    ...
                    <textarea id="requirements_note" name="requirements_note" rows="4"
                        ...
                        placeholder="Initial requirements, client notes…">{{ old('requirements_note', $project->requirements_note) }}</textarea>
