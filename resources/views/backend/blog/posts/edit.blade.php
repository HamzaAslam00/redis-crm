    ...
    <form method="POST" action="{{ route('admin.blog.posts.update', $post) }}"
        ...
        <div style="display:grid;grid-template-columns:1fr 300px;gap:1.5rem;align-items:start">
            ...
            <div style="display:flex;flex-direction:column;gap:1.5rem;position:sticky;top:1.5rem">
                ...
                {{-- Featured Image --}}
                <div class="crm-card" x-data="featuredImageUploader('{{ old('featured_image', $post->featured_image) }}')">
                    ...
                    {{-- URL fallback --}}
                    <label class="form-label" style="font-size:0.78rem">Or paste image URL</label>
