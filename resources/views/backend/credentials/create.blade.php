<x-layouts.backend title="Add Credential">

    <div style="display:flex;align-items:center;gap:1rem;margin-bottom:2rem">
        <a href="{{ route('admin.credentials.index') }}" class="btn btn-secondary btn-sm"><i class="ri-arrow-left-line"></i></a>
        <div>
            <h1 class="page-title">Add Credential</h1>
            <p class="page-subtitle">Store a new encrypted credential securely.</p>
        </div>
    </div>
    ...
    <div class="crm-card">
        <form method="POST" action="{{ route('admin.credentials.store') }}">
            ...
            <div class="form-grid-2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="system_name" name="system_name"
                        ...
                        value="{{ old('system_name') }}" placeholder="e.g. Client ABC cPanel" autofocus>
                ...
                <div class="form-group">
                    ...
                    <select id="cred_type" name="cred_type" class="form-control @error('cred_type') is-invalid @enderror">
                        @foreach($credTypes as $k => $label)
                            <option value="{{ $k }}" {{ old('cred_type', 'web_panel') === $k ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select id="owner_type" name="owner_type" class="form-control @error('owner_type') is-invalid @enderror">
                        @foreach($ownerTypes as $k => $label)
                            <option value="{{ $k }}" {{ old('owner_type', 'personal') === $k ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="owner_name" name="owner_name"
                        ...
                        value="{{ old('owner_name') }}" placeholder="Client or person name">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="username" name="username"
                        ...
                        value="{{ old('username') }}" placeholder="Login username" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email"
                        ...
                        value="{{ old('email') }}" placeholder="Login email" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="port" name="port"
                        ...
                        value="{{ old('port') }}" placeholder="e.g. 22, 3306">
                ...
                <div class="form-group" style="grid-column:span 2">
                    ...
                    <textarea id="command" name="command" rows="2"
                        class="form-control vault-input @error('command') is-invalid @enderror"
                        placeholder="e.g. ssh root@192.168.1.1 -p 22">{{ old('command') }}</textarea>
            ...
            <div style="display:flex;align-items:center;justify-content:flex-end;gap:0.75rem;padding-top:1rem;border-top:1px solid var(--crm-border);margin-top:0.5rem">
                ...
                <button type="submit" class="btn btn-primary"><i class="ri-save-line"></i> Save Credential</button>
            </div>
        </form>
    </div>
