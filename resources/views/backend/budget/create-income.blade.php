<x-layouts.backend title="Add Income">
    ...
    <div class="crm-card">
        <form method="POST" action="{{ route('admin.budget.incomes.store') }}">
            @csrf
            <div class="form-grid-2">
                ...
                <div class="form-group" style="grid-column:span 2">
                    ...
                    <input type="text" id="source" name="source"
                        ...
                        value="{{ old('source') }}" placeholder="e.g. Client Payment — Acme Corp" autofocus>
            ...
            <div style="display:flex;align-items:center;justify-content:flex-end;gap:0.75rem;padding-top:1rem;border-top:1px solid var(--crm-border);margin-top:0.5rem">
                ...
                <button type="submit" class="btn btn-primary"><i class="ri-save-line"></i> Save Income</button>
            </div>
        </form>
    </div>
